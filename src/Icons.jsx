...
export const Icons = {
  Trophy: ({ size = 20, fill = "none", stroke = "currentColor", opacity = 1 }) => (
  ...
  RichMonthTrophy: ({ monthIdx, size = 180 }) => {
    ...
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className="drop-shadow-[0_0_40px_rgba(193,154,107,0.3)]">
        <path d={shapes[monthIdx % 4]} stroke={gold} strokeWidth="1.2" />
        <path d="M7 4h10v2l-1 8c0 2-2 4-4 4s-4-2-4-4l-1-8V4z" fill="#5D2E17" stroke={gold} strokeWidth="1.5" />
  ...
  Nav: ({ type, active }) => {
    const color = active ? "#C19A6B" : "#C19A6B80";
