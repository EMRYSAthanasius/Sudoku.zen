...
export const Icons = {
  Trophy: ({ size = 20, fill = "none", stroke = "#38B2AC", opacity = 1 }) => (
  ...
  RichMonthTrophy: ({ monthIdx, size = 180 }) => {
    ...
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className="drop-shadow-[0_0_40px_rgba(56,178,172,0.3)]">
        <path d={shapes[monthIdx % 4]} stroke={frostBlue} strokeWidth="1.2" />
        <path d="M7 4h10v2l-1 8c0 2-2 4-4 4s-4-2-4-4l-1-8V4z" fill="#0F172A" stroke={frostBlue} strokeWidth="1.5" />
        <path d="M12 18v2M8 22h8M10 20h4" stroke={frostBlue} strokeWidth="2" strokeLinecap="round" />
        <circle cx="12" cy="10" r="2.5" stroke={frostBlue} strokeWidth="1" opacity="0.6" />
      </svg>
    );
  },
  Settings: () => (
    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#38B2AC" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  Nav: ({ type, active }) => {
    const color = active ? "#38B2AC" : "#64748B";
